                ...
                <div className="container mx-auto px-6 max-w-4xl">
                    <Card className="w-full shadow-lg border-t-4 border-t-primary overflow-hidden">
                        <CardHeader className="text-center pt-12 pb-8 border-b bg-white">
                            <h1 className="text-3xl md:text-4xl font-bold font-headline text-primary mb-4 uppercase tracking-tight">Enquiry Received Successfully</h1>
                            <CardDescription className="text-lg text-slate-600 max-w-xl mx-auto font-medium">
                                Thank you for your interest in the EGS Pillay Group of Institutions. Your enquiry for the academic year 2026-27 has been processed. Our admissions team will reach out to you shortly.
                            </CardDescription>
                        </CardHeader>
                            ...
                            <div className="grid md:grid-cols-2">
                                ...
                                <div className="p-8 md:p-12 space-y-10 bg-white">
                                    <div className="space-y-8">
                                        <div>
                                            <h2 className="text-sm font-bold text-primary uppercase tracking-widest mb-4 border-l-4 border-accent pl-3">Admission Office</h2>
                                            <div className="space-y-3 text-slate-800 font-bold text-xl">
                                                <p className="block tracking-tight">(+91) 86089 54537</p>
                                                <p className="block tracking-tight">(+91) 99768 88999</p>
                                                <p className="block tracking-tight">+91 93630 87377</p>
                                            </div>
                                        </div>

                                        <div>
                                            <h3 className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-2 border-l-4 border-slate-200 pl-3">Email Support</h3>
                                        ...
                                        <div className="pt-4 flex flex-col gap-4">
                                            <Button asChild className="bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold h-14 text-lg rounded-none">
                                                <a href="https://wa.me/919363087377" target="_blank" rel="noopener noreferrer">
                                                    CHAT ON WHATSAPP
                                                </a>
                                            </Button>
                                            <Button variant="outline" asChild className="h-14 font-bold text-slate-600 rounded-none border-2">
                                ...
                                {/* Map Section */}
                                <div className="h-[400px] md:h-auto bg-slate-100 relative min-h-[450px]">
                                    <iframe 
    ...
    return (
        <Suspense fallback={<div className="flex h-screen items-center justify-center bg-slate-50">
            <div className="text-center">
                ...
                <p className="font-bold text-slate-400 uppercase tracking-widest text-sm">Processing...</p>
            </div>
        </div>}>
            <SuccessContent />
        </Suspense>
